# Technical specifications — Tipsyo (MVP)

**Документ:** Техническое задание (ТЗ)  
**Продукт:** Tipsyo (рабочее название Tips’yo) — Bali-first цифровая платформа для чаевых и гостевого опыта в ресторанах, кафе, барах, кофейнях и близких F&B‑заведениях на Бали с последующим расширением на другие сервисные бизнесы (виллы, спа, бьюти).  
...
- Доступность лендинга и API Tipsyo ≥ 99.5% в рабочее время заведений.
