...
**Продукт:** Tips’yo (рабочее название Tips’yo) — Bali-first цифровая платформа для чаевых и гостевого опыта в ресторанах, кафе, барах, кофейнях и близких F&B‑заведениях на Бали с последующим расширением на другие сервисные бизнесы (виллы, спа, бьюти).  
