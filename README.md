...
Одностраничный лендинг сервиса бескэшевых чаевых Tips'yo (продуктовое имя Tipsyo) и основной источник документации, перенесённой из `Tips_yo_dev`.
...
- **Миссия:** Tipsyo создаёт на Бали стандарт цифровых чаевых и сервисов «за столом», делая чаевые удобными гостям, прозрачными персоналу и управляемыми для владельцев заведений.
