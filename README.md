...
Одностраничный лендинг сервиса бескэшевых чаевых Tips'yo (продуктовое имя Tipsio) и основной источник документации, перенесённой из `Tips_yo_dev`.
...
- **Миссия:** Tipsio создаёт на Бали стандарт цифровых чаевых и сервисов «за столом», делая чаевые удобными гостям, прозрачными персоналу и управляемыми для владельцев заведений.
